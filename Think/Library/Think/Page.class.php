...
class Page {
    ...
    protected $coolPages   ;
    // 分页显示定制
    protected $config  =    array('prev'=>'上一页','next'=>'下一页','first'=>'首页','last'=>'尾页','theme'=>'<li>%upPage%</li> <li>%downPage%</li> <li>%first%</li>  <li>%prePage%</li>  <li>%linkPage%</li>  <li>%nextPage%</li> <li>%end%</li> <li><a>%totalRow% %header% %nowPage%/%totalPage% 页</a></li>');
    // 默认分页变量名
    protected $varPage;
    /**
     * 架构函数
        ...
        for($i=1;$i<=$this->rollPage;$i++){
            ...
            if($page!=$this->nowPage){
                ...
                if($this->totalPages != 1){
                    $linkPage .= "<a style=' background-color:#555; color:#ffffff'>".$page."</a>";
                }
            }
        }
        $pageStr     =   str_replace(
